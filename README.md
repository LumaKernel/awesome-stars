...
- [EvgenyOrekhov/eslint-config-hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) - The most strict (yet practical) ESLint config. 34 plugins. 1047 rules.
...
- [jina-ai/jina](https://github.com/jina-ai/jina) - Build cross/multi-modal applications on the cloud
...
- [prisma/language-tools](https://github.com/prisma/language-tools) - 🌐 Prisma Language Tools for Prisma schema files. Home to the Language Server and Prisma's VS Code extension.
