...
- [swc-project/swc-loader](https://github.com/swc-project/swc-loader) - Webpack loader for swc.
...
- [petamoriken/float16](https://github.com/petamoriken/float16) - Stage 2 IEEE 754 half-precision floating-point ponyfill
...
- [EvgenyOrekhov/eslint-config-hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) - The most strict (yet practical) ESLint config. 46 plugins. 1231 rules. React, Vue, Node, and pure JS/TS.
...
- [neplextech/illustrator.js](https://github.com/neplextech/illustrator.js) - JavaScript image processing library
