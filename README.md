...
- [dannvix/NflxMultiSubs](https://github.com/dannvix/NflxMultiSubs) - Multiple Subtitles and Enhanced Experiences for Netflix Web App
...
- [remarkjs/remark-rehype](https://github.com/remarkjs/remark-rehype) - plugin to transform from Markdown (remark) to HTML (rehype)
...
- [EvgenyOrekhov/eslint-config-hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) - The most strict (yet practical) ESLint config. 33 plugins. 1006 rules.
...
- [kat0h/dps-bufpreview.vim](https://github.com/kat0h/dps-bufpreview.vim) - A markdown previewer for Vim and Neovim
